 ...
 */
#ifndef  IJavaSearchConstants_JIKES_SERACH_INCLUDE
#define IJavaSearchConstants_JIKES_SERACH_INCLUDE
...
public:
	 ...
	 */
		static const int FORCE_IMMEDIATE_SEARCH = Jikes::Search::IJob::ForceImmediate;
	/**
	 * The search operation throws an <code>org.eclipse.core.runtime.OperationCanceledException</code>
	 * if the underlying indexer has not finished indexing the workspace.
	 */
		static const int CANCEL_IF_NOT_READY_TO_SEARCH = Jikes::Search::IJob::CancelIfNotReady;
	/**
	 * The search operation waits for the underlying indexer to finish indexing 
	 * the workspace before starting the search.
	 */
		static const  int WAIT_UNTIL_READY_TO_SEARCH = Jikes::Search::IJob::WaitUntilReady;
