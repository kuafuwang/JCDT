// $Id: JCDT_Lib/internal/classfmt/Operators.h,v 1.18 2004/01/20 04:10:26 ericb Exp $ -*- c++ -*-
//
...
#ifdef JIKES_DEBUG
public:
    //static void OpDmp(Ostream& os, const ConstantPool&, const Tuple<u1>&, std::vector<std::vector<int>>&);
    ...
    static void OpLine(Ostream& os, const ConstantPool&, char, int, const char*,
