// $Id: JCDT_Lib/internal/impl/double.h,v 1.30 2004/06/02 11:26:22 elliott-oss Exp $ -*- c++ -*-
//
...
//
//
// NOTES: The IEEE 754 emulation code in JCDT_Lib/internal/impl/double.h and double.cpp within
...
// and decimal strings, in JCDT_Lib/internal/impl/double.h, double.cpp, JCDT_Lib/internal/env/platform.h, and
...
private:
    ...
    // the exponent is returned, the parameter fraction is modified
    int SplitInto(LongInt& fraction) const;
...
public:
    ...
    // BaseLong (JCDT_Lib/internal/impl/long.h).  However, adding const support is a big undertaking.
    //
