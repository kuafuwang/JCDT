...
public class RangeUtil {
	...
	// flags
	static const int  NO_FLAG = 0;
	static const int  LBRACE_MISSING = 1;
	...
	public static bool containsErrorInSignature(AbstractMethodDeclaration method){
	...
	public static bool containsIgnoredBody(AbstractMethodDeclaration method){
