...
#ifndef SemanticError_INCLUDED
#define SemanticError_INCLUDED
...
namespace Jikes {
	...
	public:
		enum WarningLevel
		{
			MANDATORY_ERROR = Problem::JIKES_ERROR,
			STRONG_WARNING = Problem::JIKES_CAUTION,
			WEAK_WARNING = Problem::JIKES_WARNING,
			DISABLED,
			NAMED_STRONG_ON,
			NAMED_STRONG_OFF,
			NAMED_WEAK_ON,
		...
		static void DestoryStaticMessages();
		...
		void Report(SemanticErrorKind, Token*, Token*,
		...
		SemanticError(Option*, Tuple<PathSymbol*>&, FileSymbol*);
		~SemanticError()
		{
