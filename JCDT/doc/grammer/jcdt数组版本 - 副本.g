...
--
ClassOrInterfaceType -> GenericType Marker
\:$MakeTypeArguments:\
/.$location ./
...
-- Parameterized types were added in JSR 14.
--
ArrayType ::= GenericType '.' Name Dims
\:$consumeClassOrInterfaceTypeArgumentList1NameWithDims:\
/.$location ./
...
ClassHeader ::= Marker 'class' 'Identifier' TypeParametersopt
                     Superopt Interfacesopt 
\:$NoAction:\
/.$shared_NoAction./
...
--
ClassHeader ::= Modifiers 'class' 'Identifier' TypeParametersopt
                     Superopt Interfacesopt 
\:$NoAction:\
/.$shared_NoAction./
...
-- Parameterized types were added in JSR 14.
--
ExplicitConstructorInvocation ::= OnlyTypeArguments 'this' Arguments ';'
\:$consumeExplicitConstructorThisCallInvocationWithTypeArguments:\
/.$location./
...
-- Parameterized types were added in JSR 14.
--
ExplicitConstructorInvocation ::= OnlyTypeArguments 'super' Arguments ';'
\:$consumeExplicitConstructorSuperCallInvocationWithTypeArguments:\
/.$location./
...
--                                  ';'
ExplicitConstructorInvocation ::= Primary '.' Marker 'super'
                                  Arguments ';'
\:$MakeQualifiedSuper:\
/.$location./


ExplicitConstructorInvocation ::= Primary '.' OnlyTypeArguments 'super'
                                  Arguments ';'
\:$MakeQualifiedSuper:\
/.$location./
...
--ExplicitConstructorInvocation ::= Name '.' 'super' '(' ArgumentListopt ')'
--                                  ';'
ExplicitConstructorInvocation ::= Name '.' OnlyTypeArguments 'super' Arguments ';'
\:$MakeQualifiedSuper:\
/.$shared_function
//
// void MakeQualifiedSuper();
...
InterfaceHeader ::= Marker 'interface' 'Identifier' TypeParametersopt
...
-- Modifiersopt to avoid ambiguity.
--
InterfaceHeader ::= Modifiers 'interface' 'Identifier' TypeParametersopt
                         ExtendsInterfacesopt 
\:$NoAction:\
/.$shared_NoAction./
...
AllocationHeader ::= 'new' ClassOrInterfaceType Arguments
\:$consumeClassInstanceCreationExpression:\
/.$location./
...
--ClassInstanceCreationExpression ::= 'new' ClassOrInterfaceType '('
--                                    ArgumentListopt ')' ClassBodyopt
ClassInstanceCreationExpression ::= 'new' OnlyTypeArguments ClassOrInterfaceType
...
--                                    ArgumentListopt ')' ClassBodyopt
ClassInstanceCreationExpression ::= Primary '.' 'new' Marker
                                    'Identifier' Marker Arguments
                                    ClassBodyopt
\:$MakeQualifiedNew:\
/.$location./
...
ClassInstanceCreationExpression ::= Primary '.' 'new' Marker
                                    'Identifier' OnlyTypeArguments Arguments
                                    ClassBodyopt
\:$MakeQualifiedNew:\
/.$location./

ClassInstanceCreationExpression ::= Primary '.' 'new' OnlyTypeArguments
                                    'Identifier' Marker Arguments
                                    ClassBodyopt
\:$MakeQualifiedNew:\
/.$location./
...
--                                    ArgumentListopt ')' ClassBodyopt
ClassInstanceCreationExpression ::= Name '.' 'new' Marker
                                    'Identifier' Marker Arguments
                                    ClassBodyopt
\:$MakeQualifiedNew:\
/.$location./
...
ClassInstanceCreationExpression ::= Name '.' 'new' OnlyTypeArguments
                                    'Identifier' OnlyTypeArguments Arguments
                                    ClassBodyopt
\:$MakeQualifiedNew:\
/.$location./
...
-- Parameterized types were added in JSR 14.
--
MethodInvocation ::= Name '.' OnlyTypeArguments 'Identifier' Arguments
\:$MakeMethodInvocation:\
/.$location./
...
-- Parameterized types were added in JSR 14.
--
MethodInvocation ::= Primary '.' OnlyTypeArguments 'Identifier' Arguments
\:$MakeMethodInvocation:\
/.$location./
...
--                     ArgumentListopt ')'
MethodInvocation ::= SuperAccess '.' OnlyTypeArguments 'Identifier' Arguments
\:$MakeMethodInvocation:\
/.$location./
...
-- Parameterized types were added in JSR 14.
--
CastExpression ::= '(' Name OnlyTypeArgumentsForCastExpression Dimsopt ')'
...
-- Parameterized types were added in JSR 14.
--
CastExpression ::= '(' Name OnlyTypeArgumentsForCastExpression '.' ClassOrInterfaceType
