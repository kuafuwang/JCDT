...
#ifndef SelectWhenDebugAssistASTVisitor_INCLUDED
#define SelectWhenDebugAssistASTVisitor_INCLUDED
...
namespace Jikes { // Open namespace Jikes block
	...
	namespace CodeAssist {
		class SelectWhenDebugAssistASTVisitor :public ASTVisitor
		{
		public:
			enum EnterPoint
			{
			...
			SelectWhenDebugAssistASTVisitor(vector<TypeDeclaration*>& _type_stack);
			EnterPoint enter_point_;
			Ast* enterpoint_node = nullptr;
		
			wstring getDeclareTypeName();
			unsigned pos;
			...
			std::vector<TypeDeclaration*>& type_stack;
			 ...
			 bool visit(AstVariableDeclaratorId * node,AstNodeScope* scope)override;


			 void endVisit(AstVariableDeclaratorId * node,AstNodeScope* scope)override;
		...
		//	 bool visit(EmptyStatement * node,AstNodeScope* scope)override;


		//	 void endVisit(EmptyStatement * node,AstNodeScope* scope)override;
			...
			// void endVisit(BreakStatement * node,AstNodeScope* scope)override;

			 bool visit(ContinueStatement * node,AstNodeScope* scope)override;


		//	 void endVisit(ContinueStatement * node,AstNodeScope* scope)override;

			 bool visit(ReturnStatement * node,AstNodeScope* scope)override;

		//	 void endVisit(ReturnStatement * node,AstNodeScope* scope)override;
		...
		inline void SelectWhenDebugAssistASTVisitor::TokenInPosThenNoFound(Token* tk)const
		{
			if (tk)
			{
				if (tk->IsInRange(pos))
		...
		inline bool SelectWhenDebugAssistASTVisitor::IsInRange(Ast* node) const
		{
