...
namespace Jikes { // Open namespace Jikes block
	...
	namespace CodeAssist {
		...
		public:
			...
			virtual void acceptAnonymousType(
			...
			virtual	void acceptClass(
				...
				int modifiers,
				JavaModel::ISourceRange*  completionRang,
				double  relevance , bool needMatch = true) = 0;
			/**
			 ...
			 * 		value is higher.
			 */
			virtual  void acceptKeyword( const wstring& keywordName, 
				JavaModel::ISourceRange*  completionRang, double  relevance  , bool needMatch = true) = 0;
			/**
			 ...
			 * 		value is higher.
			 */
			virtual	void acceptLabel( const wstring& labelName, JavaModel::ISourceRange* 
				completionRang, double  relevance  , bool needMatch = true) = 0;
			/**
			 ...
			 *    The default package is represented by an empty array.
			 */
			virtual void acceptLocalVariable(
				 const wstring& name,
				 const wstring& typePackageName,
				 const wstring& typeName,
				int modifiers,
			 ...
			 * NOTE: parameter names can be retrieved from the source model after the user selects a specific method.
			 */
			virtual void acceptMethodDeclaration(
				 const wstring& declaringTypePackageName,
				 const wstring& declaringTypeName,
				 const wstring& selector,
				const vector< wstring>& parameterPackageNames,
			 ...
			 * 		value is higher.
			 */
			virtual void acceptModifier( const wstring& modifierName, 
				JavaModel::ISourceRange*  completionRang, double  relevance, bool needMatch = true) = 0;
			/**
			 ...
			 *    The default package is represented by an empty array.
			 */
			virtual void acceptVariableName(
				 const wstring& typePackageName,
				 const wstring& typeName,
				 const wstring& name,
				 const wstring& completionName,
			...
			virtual void SetTokenForMatch(const wstring& token) = 0;
